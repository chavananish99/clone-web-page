...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image3": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/logoipsum-239.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image16": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/pexels-tom-swinnen-2249961.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image17": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/pexels-wendy-wei-2974618.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image22": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/chevron-left.svg"
      },
      "callbacks": {
        "onClick": [
          {
        ...
        "testimonials": [
          {
            ...
            "profile_pic": "/app-assets/t1.jpeg"
          },
          {
            "name": "Jennifer Musk",
